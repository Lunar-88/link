...
function Details() {
    ...
    return (
        <div className="bg-black text-start pl-4 md:pl-10 pt-20 min-h-screen">
            ...
            <form className="mt-5">
                <div className="mb-4 pr-6 md:w-80">
                ...
                <div className="text-center pr-6 md:w-80">
                    <button
                        onClick={() => navigate("/confirmation")}
                        className="bg-lime-300 w-full hover:bg-blue-700 text-black font-bold py-2 px-4 rounded-3xl focus:outline-none focus:shadow-outline"
                        type="button"
                    >
                        Sign In
                    </button>
